...
.controller('MessagesDetailsCtrl', ['$scope', '$filter', '$stateParams', function($scope, $filter, $stateParams) {
	...
	$scope.conversations = { 
	    ...
	    contactMessages: [
	      ...
	      sendTime: new Date("Fri Apr 25 2014 10:50:12 GMT-0700 (PDT)")},
	      { id: '002',
	      sender: 'not-you',
	      text: 'But seriously, how come you never talk to me?',
	      sendTime: new Date("Fri Apr 25 2014 10:51:12 GMT-0700 (PDT)")},
	      { id: '003',
	      sender: 'not-you',
	      ...
	      sendTime: new Date("Fri Apr 25 2014 10:52:12 GMT-0700 (PDT)")},
	      { id: '005',
	      sender: 'you',
	      text: 'STFU',
	      sendTime: new Date("Fri Apr 25 2014 10:57:12 GMT-0700 (PDT)")}
	    ],
